...
const WONDERFULSUBS_EMPTY_TTL = process.env.WONDERFULSUBS_EMPTY_TTL || 24 * 60 * 60; // 1 day
...
function cacheWrapWonderfulSubs(id, method) {
  return cacheWrap(`${WONDERFULSUBS_KEY_PREFIX}:${id}`, method, { ttl: WONDERFULSUBS_EMPTY_TTL });
}

module.exports = { cacheWrapStream, cacheWrapWonderfulSubs };
